                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <button
                          ...
                          disabled={isSyncing}
                          className="flex items-center justify-center gap-1.5 bg-blue-500 text-white hover:bg-blue-500/90 py-2 px-3 rounded-lg font-bold text-[10px] transition-all duration-200 cursor-pointer shadow-md shadow-blue-500/15 disabled:opacity-55 select-none"
                        >
                          {isSyncing ? (
                          ...
                          {language === 'id' ? 'Cadangkan' : 'Backup'}
                        </button>
                        <button
                          onClick={() => setShowRestoreModal(true)}
                          disabled={isSyncing || !backupExists}
                          className="flex items-center justify-center gap-1.5 bg-muted/30 hover:bg-muted/50 border border-border/30 text-foreground py-2 px-3 rounded-lg font-bold text-[10px] transition-all duration-200 cursor-pointer disabled:opacity-55 select-none"
                        >
                      ...
                      <button
                        ...
                        disabled={isSyncing}
                        className="flex items-center justify-center gap-1 text-[9px] font-bold text-muted-foreground/60 hover:text-rose-500 transition-colors w-full cursor-pointer disabled:opacity-50 py-0.5 select-none"
                      >
                        <LogOut className="w-2.5 h-2.5" />
                        {language === 'id' ? 'Putuskan Akun Google' : 'Disconnect Google Account'}
                      </button>
                    </div>
                  ) : (
